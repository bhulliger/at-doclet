...
public class AnnotationDrivenDocletTest {
	...
	public void testname() throws Exception {
		...
		String output = AnnotationDrivenDoclet.processScreencast(line, replacements);
	...
	/**
	 * Test method for {@link ch.puzzle.util.AnnotationDrivenDoclet#start(com.sun.javadoc.RootDoc)}.
	 */
	@Test
	public void shouldProcessCommandLineParametersInDoclet() throws Exception {
		// GIVEN
		RootDoc root = Mockito.mock(RootDoc.class);
		final String[][] providedCommandLineParameters = { { "-output", "anywhere" },
				{ "-annotation", "class1", "template1" }, { "-siteResources", "anywhere/else" } };
		...
		assertTrue(AnnotationDrivenDoclet.configuredAnnotations.containsKey("class1"));
	}
	...
	public void shouldProcessScreencastLine() throws Exception {
		...
		// WHEN
		String output = AnnotationDrivenDoclet.processLine(line, false, replacements);
	...
	public void shouldProcessScreencastsAndReplaceLineForTagWithParameters() {
		...
		final String outputLine = AnnotationDrivenDoclet.processScreencast(line, replacements);
	...
	public void shouldProcessImagesAndReplaceLineForTagWithoutParameters() {
		...
		// WHEN
		final String outputLine = AnnotationDrivenDoclet.processImages(line, new HashMap<String, String>());

		// THEN
		assertEquals("[/images/test/duke.png]", outputLine);
	}
	...
	public void shouldProcessImagesReplaceTagsInPath() {
		...
		final String outputLine = AnnotationDrivenDoclet.processImages(line, replacements);
	...
	public void shouldOnlyProcessImages() {
		// GIVEN
		// directory contains a 'not_an_image.txt' file which should not be processed.
		final String line = "anything before placeholder ~~{images:/images/test} anything after placeholder";
	...
	/**
	 * Test method for {@link ch.puzzle.util.AnnotationDrivenDoclet#optionLength(java.lang.String)}.
	 */
	@Test
	...
	public void shouldContainOptionLength3ForAnnotations() {
		...
		// WHEN
		final int optionLength = AnnotationDrivenDoclet.optionLength("-annotation");
	...
	public void shouldContainOptionLength2ForResourcesDir() {
		...
		// WHEN
		final int optionLength = AnnotationDrivenDoclet.optionLength("-siteResources");
	...
	public void shouldContainOptionLength0ForDefault() {
		...
		// WHEN
		final int optionLength = AnnotationDrivenDoclet.optionLength("-anythingElse");
	...
	public void shouldThrowExceptionIfTooManyArgumentsAreProvided() throws Exception {
		// GIVEN
		final String[][] providedCommandLineParameters = { { "-annotation", "to", "many", "parameters" } };
	 ...
	 */
	@Test(expected = UnsupportedCommandLineParameterException.class)
	public void shouldThrowExceptionIfTooFewArgumentsAreProvided() throws Exception {
		// GIVEN
	 ...
	 */
	@Test
	public void shouldTakeDefaultMavenResourcesDirIfNoneProvided() throws Exception {
		// GIVEN
		final String[][] providedCommandLineParameters = { { "-output", "anywhere" },
				{ "-annotation", "class1", "template1" } };
	...
	public void shouldProcessAnnotationParameter() throws Exception {
		// GIVEN
		final String[][] providedCommandLineParameters = { { "-annotation", "class1", "template1" },
				{ "-annotation", "class2", "template2" }, { "-output", "anywhere" } };
		...
		assertTrue(AnnotationDrivenDoclet.configuredAnnotations.containsKey("class1"));
		assertTrue(AnnotationDrivenDoclet.configuredAnnotations.containsKey("class2"));
		assertEquals("template1", AnnotationDrivenDoclet.configuredAnnotations.get("class1"));
		assertEquals("template2", AnnotationDrivenDoclet.configuredAnnotations.get("class2"));
	}
	...
	public void shouldThrowExceptionIfParameterIsMissing() throws Exception {
		// GIVEN
		final String[][] providedCommandLineParameters1 = { { "-output", "anywhere" } };
		final String[][] providedCommandLineParameters2 = { { "-annotation", "any", "any" } };
